  ...
  return (
    <>
      ...
      <ServiceHero
        ...
        backgroundAlt="Diamond core drill cutting a precise opening through a heavily reinforced concrete slab"
        benefits={[
      ...
      <GalleryCallout tag="Diamond Drilling" />

      <CoverageNote service="diamond-drilling" />

      <IndustriesServed service="diamond-drilling" />
