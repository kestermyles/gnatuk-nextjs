...
export const metadata: Metadata = {
  ...
  description:
    'Selected GNAT UK projects across water, healthcare, COMAH, data centres and nuclear decommissioning. Method-led demolition for confined, live and structurally sensitive environments.',
  alternates: { canonical: `${SITE.url}/case-studies` },
  openGraph: {
    title: 'Case Studies | GNAT UK',
    description:
      'Method-led demolition across water, healthcare, COMAH, data centres and nuclear decommissioning.',
        ...
        <div className="container-prose py-14 md:py-20">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-relaxed text-gnat-steel-dark">
              Selected projects across water, healthcare, COMAH, data centres and nuclear
              decommissioning — where the method was the difference between a workable
            ...
            {CASE_STUDIES.map((cs) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-6">
                  ...
                  <h2 className="mt-2 text-xl font-bold leading-snug text-gnat-navy">
                    {cs.title}
                  </h2>
                  <p className="mt-3 text-sm leading-relaxed text-gnat-steel-dark">
                    {cs.summary}
                  </p>
                  <div className="mt-5 flex items-center justify-between border-t border-gnat-concrete pt-4 text-xs text-gnat-steel-dark">
                    <span>
                      {cs.location} &middot; {cs.year}
                    </span>
                    <span className="font-semibold text-gnat-navy group-hover:text-gnat-orange">
                      Read project →
                    </span>
                  </div>
                </div>
