        ...
        <div className="container-prose flex h-10 items-center justify-between text-sm">
          ...
          <div className="hidden items-center gap-2 sm:flex">
            ...
            <a
              ...
              onClick={() =>
                track({ event: 'social_outbound', social_network: 'linkedin', social_location: 'utility_bar' })
              }
              className="flex h-7 w-7 items-center justify-center rounded-full text-gnat-navy transition hover:bg-white hover:text-gnat-orange"
            >
              <svg
                width="16"
                height="16"
